<div x-data="{ submittion: @entangle('submittion_modal'), decline: @entangle('decline_modal') }">
  ...
  <div x-show="submittion" x-cloak class="relative z-10" aria-labelledby="slide-over-title" role="dialog" aria-modal="true">
    ...
    -->
                    <div class="pt-1.5">
                      ...
                      <p class="text-sm font-medium text-gray-500">Submitted Date: {{ $student_data->created_at ?? '' }}
                      </p>
                    </div>
                  </div>
                </div>
                        ...
                        <li class="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                          <div class="flex w-0 flex-1 items-center">
                            ...
                            <div class="ml-4 flex min-w-0 flex-1 gap-2">
                              <span class="truncate font-medium">{{ $item->file_name }}</span>
                            </div>
                          </div>
  ...
  -->
    ...
    <div class="fixed inset-0 z-10 overflow-y-auto">
      ...
      -->
        <div x-show="decline" x-cloak x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
          ...
          <div class="">
            <div class="sm:flex sm:items-start">
              ...
              <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">Reason to decline</h3>
            ...
            <div class="mt-2 ">
              <div class="flex items-start space-x-4">
                <div class="flex-shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-10 fill-gray-600" viewBox="0 0 24 24">
                    <path
