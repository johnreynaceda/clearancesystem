        ...
        <div x-data="{ open: false }"
            ...
            <nav :class="{ 'flex': open, 'hidden': !open }"
                ...
                <div class="inline-flex items-center gap-2 list-none lg:ml-auto">
                    <div class="relative flex space-x-3 items-center flex-shrink-0 ml-5" @click.away="open = false"
                        x-data="{ open: false }">
                        ...
                        <div>
                            <button @click="open = !open" type="button"
                                ...
                                @if (auth()->user()->student->student_profile)
                                    <img class="object-cover w-10 h-10 rounded-full"
                                        src="{{ Storage::url(auth()->user()->student->student_profile) }}"
                                        alt="">
                                @else
                                    <img class="object-cover w-10 h-10 rounded-full"
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-100"
                            ...
                            class="absolute right-5 z-10 w-48 py-1 -bottom-24 origin-top-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                            ...
                            <li>
                                <div class="flex items-center">
                                    <a href="{{ route('adviser.dashboard') }}"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 fill-gray-500"
                                            viewBox="0 0 24 24">
                                            <path
