  ...
  <div class="w-full mx-auto bg-white border-b 2xl:max-w-7xl">
    <div x-data="{ open: false }"
      ...
      <nav :class="{ 'flex': open, 'hidden': !open }"
        ...
        <a class="px-2 py-2 text-sm text-gray-500 lg:px-6 md:px-3 font-medium hover:text-blue-600" href="#">
          Settings
        </a>
        <div class="inline-flex items-center gap-2 list-none lg:ml-auto">
          <div class="relative flex space-x-2 items-center flex-shrink-0 ml-5" @click.away="open = false" x-data="{ open: false }">
            ...
            <div x-show="open" x-transition:enter="transition ease-out duration-100"
              ...
              <a href="{{route('subject-teacher.profile')}}" class="block px-4 py-2 text-sm text-gray-500" 
             >
                Profile
              </a>
